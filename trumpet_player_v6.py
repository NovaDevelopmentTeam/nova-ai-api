...
def create_random_trumpet_chords():
    ...
    for i in range(3):  # Simuliere 3 Trompeten für dreistimmige Akkorde
        ...
        trumpet_part.insert(0, m21.instrument.Trumpet())  # Setze das Instrument explizit
    ...
    possible_lengths = [1, 1.5, 2, 3] # Halbe-, Viertel-, Ganze Noten etc. [0.5, 1, 1.5, 2]
...
def create_algorithmic_trumpet_chords():
    ...
    # Erweiterte Liste der möglichen Notenlängen
    possible_lengths2 = [1, 1.5, 2, 3] # [0.5, 1, 1.5, 2]
